...
def templateconst(template):
    ...
    return temp
#polygon to text
header,footer,verties = extract('C:\\Users\\ktuser\\Downloads\\KLAWorkshop\\Milestone3\\Source.txt')
headertemp,footertemp,template = extract('C:\\Users\\ktuser\\Downloads\\KLAWorkshop\\Milestone3\\POI.txt')
...
out = "".join(output)
with open('milestone 3.txt', 'w') as f:
    f.write(out)
